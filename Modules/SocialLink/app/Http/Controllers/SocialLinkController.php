...
class SocialLinkController extends Controller {
    ...
    public function store(Request $request) {
        ...
        $request->validate([
            'link' => ['required'],
            'icon' => ['required', 'image', 'max:2048','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ]);
    ...
    public function update(Request $request, $id) {
        ...
        $request->validate([
            'link' => ['required'],
            'icon' => ['nullable', 'image', 'max:2048','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ]);
