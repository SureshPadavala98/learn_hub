                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-commission-setting') }}" method="POST">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label for="instructor_earning_hold">{{ __('Instructor Earnings Hold') }} ({{__('Days')}})</label>
                                                                        <input type="number" min="1" id="instructor_earning_hold" name="instructor_earning_hold"
                                                                            class="form-control" value="{{ $setting->instructor_earning_hold }}">
                                                                    </div>
                                                                </div>
