...
class BrandController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'image' => ['required', 'image', 'max:2048','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'name' => ['required', 'max:255'],
            'image' => ['nullable', 'image', 'max:2048','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
            'status' => ['required', 'boolean'],
        ]);
