...
import mediaImage from '@images/sections/testimonial-five.webp';
...
export default (editor, { folderName, fileName }, baseUrl) => {
    registerComponent({
        ...
        model: {
            defaults: {
                tagName: "section",
                attributes: { class: "home_language testimonial__area-five section-pb-130" },
                traits: [
                                ...
                                <div class="col-xl-5 col-lg-6 col-md-8">
                                    <div class="testimonial__img-three tg-svg">
                                        ...
                                        <div class="banner__review" data-aos="fade-left" data-aos-delay="1000">
                                            <div class="icon">
                                                <img src="${baseUrl}/frontend/img/icons/star.svg" alt=""
                                                    class="injectable">
                                            </div>
                                            <h6 class="title">5/5
                                        ...
                                        <div class="testimonial__img-icon">
                                            <img src="${baseUrl}/frontend/img/icons/quote02.svg" alt=""
                                                class="injectable">
                                        </div>
                                    </div>
                                </div>
