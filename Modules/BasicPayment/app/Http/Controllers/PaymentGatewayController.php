...
class PaymentGatewayController extends Controller {
    public function razorpay_update(Request $request) {
        ...
        $rules = [
            ...
            'razorpay_image' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ];
        $customMessages = [
    ...
    public function flutterwave_update(Request $request) {
        ...
        $rules = [
            ...
            'flutterwave_image' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ];
        $customMessages = [
    ...
    public function paystack_update(Request $request) {
        ...
        $rules = [
            ...
            'paystack_image' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ];
        $customMessages = [
    ...
    public function mollie_update(Request $request) {
        ...
        $rules = [
            ...
            'mollie_image' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ];
        $customMessages = [
    ...
    public function instamojo_update(Request $request) {
        ...
        $rules = [
            ...
            'instamojo_image' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ];
        $customMessages = [
    ...
    public function azampay_update(Request $request) {
        ...
        $rules = [
            ...
            'azampay_image' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ];
        $customMessages = [
    ...
    public function xendit_update(Request $request) {
        ...
        $rules = [
            ...
            'xendit_image' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ];
        $customMessages = [
