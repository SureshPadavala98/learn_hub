...
class BasicPaymentController extends Controller {
    ...
    public function update_stripe(Request $request) {
        ...
        $rules = [
            ...
            'stripe_image' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ];
        $customMessages = [
    ...
    public function update_bank_payment(Request $request) {
        ...
        $rules = [
            ...
            'bank_image' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ];
    ...
    public function update_offline_payment(Request $request) {
        ...
        $request->validate([
            'offline_image' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ]);
    ...
    public function update_braintree(Request $request) {
        ...
        $rules = [
            ...
            'braintree_image' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ];
        $customMessages = [
    ...
    public function mpesa_update(Request $request) {
        ...
        $rules = [
            ...
            'mpesa_image' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
        ];
        $customMessages = [
