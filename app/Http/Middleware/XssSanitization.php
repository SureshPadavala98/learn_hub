...
class XssSanitization {
    ...
    public function handle(Request $request, Closure $next): Response {
        ...
        array_walk_recursive($input, function (&$input) use ($html_event_attributes) {
            $input = strip_tags(str_replace(array("&lt;", "&gt;"), '', $input), '<span><p><a><b><i><u><strong><br><hr><table><tr><th><td><ul><ol><li><h1><h2><h3><h4><h5><h6><del><ins><sup><sub><pre><address><img><figure><embed><iframe><video><style><section><div><button><svg><path><em><small><mark><blockquote><code><nav>');
