...
class StudentProfileUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'avatar' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
            'cover' => ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
    ...
    function messages(): array
    {
        return [
            ...
            'avatar.image' => __('The image must be an image'),
            'avatar.max' => __('The image may not be greater than 2000 kilobytes'),
