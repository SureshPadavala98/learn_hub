...
import blogManagerImg from '@images/sections/blog-two.webp';
                ...
                <div class="blog__post-item-five shine__animate-item">
                    <div class="blog__post-thumb-five">
                        <a href="#" class="shine__animate-link"><img
                                src="${placeholderImage}" alt="Blog Title"></a>
                    </div>
...
export default (editor,{folderName, fileName} ) => {
    registerComponent({
        ...
        model: {
            defaults: {
                tagName: "section",
                attributes: { class: "blog__post-area-seven section-pt-140 section-pb-110" },
                traits: [
