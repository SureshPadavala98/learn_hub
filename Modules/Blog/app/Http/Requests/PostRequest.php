...
class PostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if ($this->isMethod('put')) {
            ...
            $rules['image'] = ['nullable', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'];
        }
        if ($this->isMethod('post')) {
            $rules['image'] = ['required', 'image', 'max:2000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'];
