...
class CertificateUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'background' => ['nullable', 'image', 'max:3000','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],
            'title' => ['nullable', 'string', 'max:255'],
            'sub_title' => ['nullable', 'string', 'max:255'],
            'description' => ['nullable', 'string', 'max:600'],
            'signature' => ['nullable', 'image', 'max:512', 'dimensions:max_width=500,min_height=10','mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml'],   
        ];
    }
