                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            <td>{{ __('Order Id') }}</td>
                                            <td>#<a target="_blank"
                                                    href="{{ route('admin.order', $refund_request?->order?->invoice_id) }}">{{ $refund_request?->order?->invoice_id }}</a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>{{ __('Method') }}</td>
                                            <td>{!! clean(nl2br($refund_request->method)) !!}</td>
                                        </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p class="text-danger">{{ __('Are You Sure to Reject this refund ?') }}</p>
