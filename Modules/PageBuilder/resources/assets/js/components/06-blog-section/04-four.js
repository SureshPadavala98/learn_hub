...
import blogManagerImg from '@images/sections/blog-four.webp';
...
export default (editor, { folderName, fileName }) => {
    registerComponent({
        ...
        model: {
            defaults: {
                tagName: "section",
                attributes: { class: "blog__post-area-eight section-pt-140 section-pb-110" },
                traits: [
            ...
            init() {
                ...
                wrapper.on('change:total change:sub_title change:title change:description', () => {
